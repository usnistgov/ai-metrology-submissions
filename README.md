# Metric submissions — NIST AI Metrology Hub

This repository is the public intake point for **community submissions of AI metrics and
measurement methodologies** proposed for inclusion in the NIST AI Metrology Hub:
...
(merged) submission is considered for publication on the hub.
...
[hub](https://airc.nist.gov/metrology/).
